...
from douyin.open.oauth2.api_client import ApiClient
...
class DefaultApi(object):
    ...
    def platform_oauth_connect_get(self, client_key, response_type, scope, redirect_uri, **kwargs):
        """获取授权码(code)
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.platform_oauth_connect_get(client_key, response_type, scope, redirect_uri, async_req=False)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.platform_oauth_connect_get_with_http_info(client_key, response_type, scope, redirect_uri, **kwargs)
        else:
            (data) = self.platform_oauth_connect_get_with_http_info(client_key, response_type, scope, redirect_uri, **kwargs)
            return data

    def platform_oauth_connect_get_with_http_info(self, client_key, response_type, scope, redirect_uri, **kwargs):
        ...
        if ('client_key' not in params or
                params['client_key'] is None):
            raise ValueError("Missing the required parameter `client_key` when calling `platform_oauth_connect_get`")
        # verify the required parameter 'response_type' is set
        if ('response_type' not in params or
                params['response_type'] is None):
            raise ValueError("Missing the required parameter `response_type` when calling `platform_oauth_connect_get`")
        # verify the required parameter 'scope' is set
        if ('scope' not in params or
                params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `platform_oauth_connect_get`")
        # verify the required parameter 'redirect_uri' is set
        if ('redirect_uri' not in params or
                params['redirect_uri'] is None):
            raise ValueError("Missing the required parameter `redirect_uri` when calling `platform_oauth_connect_get`")
